...
# 화면 타이틀 설정
pygame.display.set_caption("fall_game")
...
character = pygame.image.load(os.path.join(
    image_path, 'character.png')).convert_alpha()
...
weapon = pygame.image.load(os.path.join(
    image_path, 'weapon.png')).convert_alpha()
...
ball_images = [
    pygame.image.load(os.path.join(image_path, 'enemy1.png')).convert_alpha(),
    pygame.image.load(os.path.join(image_path, 'enemy2.png')).convert_alpha(),
    pygame.image.load(os.path.join(image_path, 'enemy3.png')).convert_alpha(),
    pygame.image.load(os.path.join(image_path, 'enemy4.png')).convert_alpha()
]
